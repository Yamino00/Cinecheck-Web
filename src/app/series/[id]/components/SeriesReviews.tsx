...
export default function SeriesReviews({ seriesId, seriesTitle }: SeriesReviewsProps) {
      ...
      <Card className="p-12 text-center space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground max-w-md mx-auto">
            Sii il primo a recensire "{seriesTitle}"! Completa il quiz per sbloccare la possibilità di scrivere una recensione verificata.
          </p>
        </div>
